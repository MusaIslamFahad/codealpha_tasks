...
**VisionTrack AI** is a production-grade, multi-object detection and tracking system built as part of the [CodeAlpha](https://www.codealpha.tech/) AI/ML Internship. It combines **YOLOv8** (Ultralytics) for fast and accurate detection with **BoT-SORT** or **ByteTrack** to assign persistent IDs and render movement trails across frames for all 80 COCO object classes.
